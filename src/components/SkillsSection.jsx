...
const skills = [
  ...
  { name: "Firebase", level: "Intermediate", icon: <Icon icon="simple-icons:firebase" className="w-6 h-6 text-amber-500" />, category: "backend" },
  { name: "PHP", level: "Advanced", icon: <Icon icon="simple-icons:php" className="w-6 h-6 text-indigo-600" />, category: "backend" },
